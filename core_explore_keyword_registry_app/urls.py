...
urlpatterns = [
    re_path(r'^get-refinement-count', registry_ajax.RefinementCountView.as_view(),
            name='core_explore_keyword_refinement_count'),
    re_path(r'^suggestions$', registry_ajax.SuggestionsKeywordRegistrySearchView.as_view(),
            name='core_explore_keyword_suggestions'),
    re_path(r'^$', registry_views.KeywordSearchRegistryView.as_view(),
            name='core_explore_keyword_app_search'),
    re_path(r'^(?P<query_id>\w+)$', registry_views.KeywordSearchRegistryView.as_view(),
            name='core_explore_keyword_app_search'),
